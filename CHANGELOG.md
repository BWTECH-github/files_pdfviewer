...
- Rahmenschutz ließ sich umgehen: Er prüfte location.href auf „?file=blob“, ein Anhängsel „#?file=blob“ öffnete den Betrachter deshalb auf oberster Ebene. Geprüft wird jetzt der Abfrageparameter „file“ so, wie pdf.js ihn liest (Schlüssel kleingeschrieben, bei mehrfachem Vorkommen zählt der letzte Wert). Eine bloße Suche nach „file=blob“ im Abfrageteil ließ sich mit „?file=/pfad/zur.pdf&x=file=blob“ weiter überlisten. Der Rahmenschutz ist keine Sicherheitsgrenze: Die Schutzvorgaben gegen CVE-2024-4367 gelten in jeder Ansicht, auch auf oberster Ebene; er sorgt nur dafür, dass der Betrachter innerhalb der Anwendung läuft.
